  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-bold">자기소개</h1>
      ...
      <section className="mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-gray-600 leading-relaxed">{about?.intro || '안녕하세요! 저는 웹 개발자입니다. 사용자 경험을 중요시하며, 항상 새로운 기술을 배우고 적용하는 것을 좋아합니다.'}</p>
        </div>
      </section>
      <section className="mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-semibold mb-4">목표</h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-medium">{about?.email || 'example@email.com'}</p>
            </div>
            <div>
              <p className="text-gray-600">GitHub</p>
              <p className="font-medium">{about?.github || 'github.com/username'}</p>
            </div>
          </div>
        </div>
      </section>
